...
public class FrameLoginChat extends JFrame {
	...
	public FrameLoginChat() {
		...
		txtUsername.setBounds(0, 10, 288, 46);
		...
		txtPassword.setBounds(0, 10, 251, 46);
		...
		lblNewLabel.setBounds(261, 10, 37, 46);
		panel_1.add(lblNewLabel);
		
		
		JPanel pnlBtnLogin = new JPanel();
		pnlBtnLogin.setBorder(new LineBorder(new Color(0, 0, 0), 2));
		...
		lblNewLabel_1.setBounds(231, 0, 68, 59);
